      ...
      body: RefreshBase(
          onRefresh: () async {
            context
                ...
                .getRequestBoxById(context, requestBoxId: requestBox.id ?? -1);
          },
                    ...
                    children: [
                      ListTile(
                        ...
                        leading: CircleAvatar(
                          child: ClipOval(
                            child:
                                ProfileImage(url: requestBox.sendUser?.image),
                          ),
                        ),
                        title: Text(
                            requestBox.sendUser?.completeName ?? 'Unknown'),
                        trailing: Text(
                          DateFormat.yMd()
                              .add_jm()
                              .format(requestBox.showDate ?? DateTime.now()),
                          ...
                          children: (requestBox.replayBoxes ?? [])
                              .map(
                                (replayBox) => Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color:
                                          ColorManager.scaffoldBackgroundLight,
                                  ...
                                  child: ExpansionTile(
                                    ...
                                    title: Text(
                                        replayBox.sendUser?.completeName ??
                                            'Unknown'),
                                    subtitle: Column(
                                      crossAxisAlignment:
