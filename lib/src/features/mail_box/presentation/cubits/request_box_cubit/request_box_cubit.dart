...
class RequestBoxCubit extends Cubit<RequestBoxState> {
  ...
  void init(BuildContext context) {
    ...
    pagingAdapterSend.initPageRequestListener(
        context, pagingAdapterSend.pagingController);

    pagingAdapterRec.init();
    pagingAdapterRec.initPageRequestListener(
        context, pagingAdapterRec.pagingController);
  ...
  ///old api
  Future<void> getRequestBoxesBase(BuildContext context,
      ...
      required String nameList}) async {
    emit(
      loading(),
    );
