...
class ReciveRequestBoxState with _$ReciveRequestBoxState {
  ...
  const factory ReciveRequestBoxState.failure(
      NetworkExceptions? networkException) = _Failure;
  const factory ReciveRequestBoxState.success(
      RequestBox? data, String? message) = _Success;

  const factory ReciveRequestBoxState.loadingPagination() = _LoadingPagination;
  const factory ReciveRequestBoxState.emptyPagination(String? message) =
      _EmptyPagination;
  const factory ReciveRequestBoxState.failurePagination(
      NetworkExceptions? networkException) = _FailurePagination;
  const factory ReciveRequestBoxState.successPagination(
